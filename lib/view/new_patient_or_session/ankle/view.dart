...
part 'widgets/ankle_test_page1.dart';
part 'widgets/ankle_test_page2.dart';

class AnkleContentView extends StatelessWidget {
  final PatientMainStateAnkle state;
  const AnkleContentView({Key? key, required this.state}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    switch (state.currentStep) {
      case 1:
        return _AnkleTestPage1();
      case 2:
        return _AnkleTestPage2();
