...
part 'widgets/wrest_finger_test_page1.dart';
part 'widgets/wrest_finger_test_page2.dart';
part 'widgets/wrest_finger_test_page3.dart';

class WrestFingerContentView extends StatelessWidget {
  final PatientMainStateWrestFinger state;
  const WrestFingerContentView({Key? key, required this.state})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    switch (state.currentStep) {
      case 1:
        return _WrestFingerTestPage1();
      case 2:
        return _WrestFingerTestPage2();
      case 3:
        return _WrestFingerTestPage3();
      default:
